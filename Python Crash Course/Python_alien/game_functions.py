...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    ...
    # When you call draw to a group pygame automatically draws wach element in the group at the position defined vy its rect attribute.
    aliens.draw(screen)
...
def get_number_alien_x(ai_settings, alien_width):
    """Determines the number of alien that fit in a screen"""
...
def create_alien(ai_settings, screen, aliens, alien_number, row_number):
    ...
    # print("alien.x ", alien.x)
    # print('alien width ', alien_width)
    # print('alien_number', alien_number)
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """
    Check if hte flee is at an edge,
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if stats.ship_left > 0:
        ...
        # Create a new fleet and center the ship. 5
        create_fleet(ai_settings, screen, ship, aliens)
        ship.center_ship()
